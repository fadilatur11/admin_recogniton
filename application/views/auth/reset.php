        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mx-md-auto">
                    ...
                    <form action="<?php echo site_url('auth/actionreset/'.$akun['id']);?>" method="post">
                        <div class="form-group has-icon"><i class="icon-envelope-o"></i>
                            <input type="email" name="email" class="form-control form-control-lg"
                                   placeholder="Enter your email address" value="<?=$akun['email'];?>" disabled><br>
                            <input type="text" class="form-control form-control-lg" name="code" placeholder="Confirmation your code">
                        </div>
